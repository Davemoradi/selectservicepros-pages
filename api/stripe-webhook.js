...
// ============================================================
// WF5 Welcome Email ownership note:
// WF5 (Contractor Welcome Email with password reset link) is fired by
// /api/create-contractor, NOT from this webhook. That module owns auth user
// creation + password reset link generation + welcome email. Firing from
// here would either send a duplicate email, or send one without the reset
// link (making the CTA button useless). Leave WF5 ownership with the
// signup API and let this webhook focus only on Stripe state sync.
// ============================================================
